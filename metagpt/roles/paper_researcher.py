...
from metagpt.tools.academic_search import AcademicSearchTool, get_academic_search_tool


PAPER_RESEARCH_SYSTEM_PROMPT = """You are an academic paper researcher. 
Your goal is to help users efficiently search, analyze, and summarize academic papers.
You should provide accurate, well-structured, and comprehensive research results.
...
4. Analyze citation relationships
5. Rank papers and provide reading recommendations
"""
...
"""
    ...
    async def get_paper_full_details(self, paper_id: str) -> str:
        """
        获取单篇论文的完整详情
        ...
        Returns:
            str: 论文详情
        """
        details_action = FetchPaperDetails()
        details_action.set_context(self.context)
        details_action.set_llm(self.llm)
        
        return await details_action.run(
            paper_id=paper_id,
